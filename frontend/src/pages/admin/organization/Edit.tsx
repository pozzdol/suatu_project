  ...
  const fetchData = async () => {
    ...
    try {
      const response = await requestApi.get(
        `/general/setup/organizations/edit/${id}`
      );
      if (response && response.data.success) {
        setFormData(response.data.data.organizations);
        setOriginalData(response.data.data.organizations);
      } else {
      ...
      <div className="mt-6 p-6 bg-white rounded-lg shadow">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
          ...
          <div className="space-y-2">
            ...
            <Checkbox
              className="w-full bg-primary-100 px-6! py-4! rounded-lg border border-primary-600 font-semibold!"
            ...
            >
              <div className="ml-2">
                ...
                <div className="text-primary-700">
                  If checked, this organization will be active and available for
                  use.
                </div>
              </div>
            </Checkbox>
