      ...
      if (response && response.data.success) {
        const mappedOrders: WorkOrder[] =
          response.data.data.workOrders?.map((order: any) => ({
            ...
            customerPo: order.orderPo || "Unknown User",
      ...
      <div className="mt-4 space-y-6">
        ...
        <div className="relative max-w-md">
          ...
          <input
            ...
            placeholder="Search orders, customers, PO, or items..."
            value={searchQuery}
            onChange={(e) => {
          ...
          <div className="bg-white rounded-xl border border-dashed border-gray-300 p-10 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              {searchQuery
                ...
                : "Pesanan yang sudah dikonfirmasi akan tampil di sini. Gunakan halaman Orders untuk membuat Work Order baru."}
            </p>
          </div>
        ) : (
          <>
              ...
              {paginatedOrders.map((order) => (
                ...
                >
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100 flex flex-wrap gap-3">
                    ...
                    <button
                      type="button"
                      className="inline-flex cursor-pointer items-center gap-2 px-4 py-2 bg-white text-sm font-medium rounded-full border border-gray-200 text-gray-700 hover:border-sky-200 hover:text-sky-600 transition-all duration-200 flex-1 justify-center"
                  ...
                  <div>
                    ...
                    >
                      ...
                      {Array.from({ length: totalPages }).map((_, idx) => {
                        ...
                        // For now, showing all pages or a simple range is fine for typical loads
                        if (
                          totalPages > 7 &&
                          pageNumber !== 1 &&
